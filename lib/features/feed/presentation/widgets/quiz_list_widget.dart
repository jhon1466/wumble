...
class QuizListWidget extends StatefulWidget {
  ...
  QuizListWidget({super.key, required this.communityId});
            ...
            return ListView(
              ...
              children: [
                SizedBox(
                  ...
                  child: Center(
                    child: Text(tr('No hay quizzes aún.'), style: TextStyle(color: Colors.white38)),
                  ),
                ),
              ],
            );
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              title: Text(tr('Editar Quiz'), style: TextStyle(color: Colors.white)),
              onTap: () {
            ...
            ListTile(
              ...
              title: Text(tr('Eliminar Quiz'), style: TextStyle(color: Colors.redAccent)),
              onTap: () async {
                final confirm = await showDialog<bool>(
                  context: context,
                  builder: (context) => AlertDialog(
                    backgroundColor: const Color(0xFF1E1E2C),
                    title: Text(tr('¿Eliminar Quiz?'), style: TextStyle(color: Colors.white)),
